  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden pt-16 md:pt-20">
      ...
      <div className="container mx-auto px-4 text-center z-10 animate-fade-in py-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 leading-tight px-2" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.8)' }}>
          Безопасность вашего бассейна под контролем
        </h1>
        <p className="text-base sm:text-lg md:text-xl mb-3 px-2 font-semibold" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.8)' }}>
