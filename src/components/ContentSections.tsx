        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <Card className="p-8 md:p-12 hover:shadow-2xl transition-all">
              ...
              <div className="prose prose-lg max-w-none text-slate-700 space-y-4">
                <p>Браслеты Sentag имеют ключевое значение для корректного обнаружения опасности утопления и должны быть всегда исправны, чтобы выполнять свою задачу.</p>
                <p>Для проверки функциональности Браслеты оснащены <strong>встроенной системой самопроверки</strong> и постоянно сообщают о своем состоянии на Sentag Tester.</p>
