      ...
      <div>
        ...
        {showConsentText && (
          <div className="mt-3 p-4 bg-slate-50 rounded-lg border border-slate-200 text-xs text-slate-600 leading-relaxed animate-fade-in">
            ...
            <p>
              Обработка включает все действия от сбора до уничтожения (полный перечень указан в политике конфиденциальности). Я ознакомлен с Политикой конфиденциальности, где указан порядок отзыва согласия через e-mail: <strong>info@meridian-t.ru</strong>.
            </p>
          </div>
        )}
